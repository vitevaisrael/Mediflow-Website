...
import { Database, ArrowLeft, CheckCircle, BarChart3, Shield, Zap } from 'lucide-react';
...
const MedicalDataOrganization = () => {
  ...
  const features = [
    {
      ...
      description: 'Intelligent algorithms automatically extract and categorize medical data from various sources including EHRs, lab results, and imaging reports.'
    },
    {
      icon: BarChart3,
      title: 'Smart Categorization',
      description: 'AI-powered classification system organizes data into meaningful categories, making it instantly searchable and accessible.'
    },
    {
      icon: Zap,
      title: 'Real-time Synchronization',
      description: 'Seamless integration with existing systems ensures data is always up-to-date across all platforms and departments.'
    },
    {
      icon: Shield,
  ...
  return (
    <>
      <Helmet>
        <title>Medical Data Organization | Mediflow</title>
        <meta
          name="description"
          content="AI-powered categorization for searchable, structured medical records."
        />
        <meta
          property="og:title"
          content="Medical Data Organization | Mediflow"
        />
        <meta
        ...
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Ready to Organize Your Medical Data?
            </h2>
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
              Discover how our AI-powered data organization can transform your healthcare operations 
...
export default MedicalDataOrganization;
