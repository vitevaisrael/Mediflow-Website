...
const AdvancedAnalyticsPlatform = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Advanced Analytics Platform | Mediflow</title>
        <meta
          name="description"
          content="Visual dashboards and trend analysis for data-driven healthcare decisions."
        />
        <meta
          property="og:title"
          content="Advanced Analytics Platform | Mediflow"
        />
        <meta
